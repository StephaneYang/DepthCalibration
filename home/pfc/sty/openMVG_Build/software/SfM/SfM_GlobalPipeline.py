...
OPENMVG_SFM_BIN = "/home/pfc/sty/openMVG_Build/Linux-x86_64-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/pfc/sty/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
# Modification to take account of the intrinsics that was not provided in the metadata - 1/2
intrinsics = sys.argv[3]+";"+sys.argv[4]+";"+sys.argv[5]+";"+sys.argv[6]+";"+sys.argv[7]+";"+sys.argv[8]+";"+sys.argv[9]+";"+sys.argv[10]+";"+sys.argv[11]+";"
...
# Modification to take account of the focal distance that was not provided in the metadata - 2/2
#pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-k", intrinsics] )
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-k", intrinsics] )

pIntrisics.wait()

print ("2. Compute features")
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures"),  "-i", matches_dir+"/sfm_data.json", "-o", matches_dir, "-m", "AKAZE_MLDB"] )
pFeatures.wait()
